...
- [x] Testing
- [x] Complete
- [x] File organization refactored (2024-11-14)
...
## File Organization Refactor (2024-11-14)

Reorganized components following architecture rules to improve maintainability:

### New Structure - components/tables/
- **core/** (4 files) - Foundational table components
  - DynamicTable.tsx - Main table rendering
  - DynamicFieldRenderer.tsx - Field rendering logic
  - CompactTableView.tsx - Simplified table view
  - BulkActionBar.tsx - Bulk action toolbar

- **modals/** (9 files) - All modal dialogs
  - AddRecordModal.tsx, EditRecordModal.tsx, DeleteRecordModal.tsx
  - AddRecordModalWithImport.tsx, BulkDeleteModal.tsx
  - AddColumnModal.tsx, AddStatusModal.tsx, EditStatusModal.tsx, BulkStatusModal.tsx

- **managers/** (4 files) - Management interfaces
  - ColumnManager.tsx, ColumnManagerWrapper.tsx
  - EnhancedColumnManager.tsx, StatusManager.tsx

- **views/** (3 files) - Page-level views
  - TableDataView.tsx, TableMainView.tsx, TableTemplates.tsx

- **deprecated/** (3 files) - Old files to be removed
  - TableLayoutClient.tsx, EnhancedTableView.tsx, TableView.tsx

### New Structure - components/import/
- **core/** (1 file) - Main import component
  - DataImport.tsx (moved from tables)

- **wizard/** (2 files) - Wizard orchestration
  - ImportWizard.tsx, TableSelector.tsx

- **steps/** (8 files) - Individual wizard steps
  - FileUpload.tsx, ColumnMapper.tsx, ColumnMapping.tsx
  - DataPreview.tsx, DuplicateResolver.tsx
  - ImportPreview.tsx, ImportProgress.tsx, ImportSummary.tsx

### Benefits
- Clear separation of concerns by domain/feature
- Each directory has ≤10 files (following architecture rules)
- One-way dependency flow: views → modals → core
